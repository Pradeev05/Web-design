...
document.getElementById("tot").addEventListener("click", function () {
    var s1 = parseInt(document.getElementById("wt").value);
    var s2 = parseInt(document.getElementById("se").value);
    var s3 = parseInt(document.getElementById("cn").value);
    var s4 = parseInt(document.getElementById("ad").value);
    var s5 = parseInt(document.getElementById("ce").value);
...
document.getElementById("gra").addEventListener("click", function () {
    ...
    var s5 = parseInt(document.getElementById("ce").value);
    if (s1 >= 0 && s1 <= 100 && s2 >= 0 && s2 <= 100 && s3 >= 0 && s3 <= 100 && s4 >= 0 && s4 <= 100 && s5 >= 0 && s5 <= 100) {
        var total = s1 / 10 + s2 / 10 + s3 / 10 + s4 / 10 + s5 / 10;
        var avg = total / 5.0;
        if (g == "") {
